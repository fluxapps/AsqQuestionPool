 ...
 *
 * @ilCtrl_isCalledBy srag\Plugins\AsqQuestionPool\Config\ConfigCtrl: ilAsqQuestionPoolConfigGUI
 */
class ConfigCtrl
{
    ...
    protected function configure() : void
    {
        ...
        $form = self::asqQuestionPool()->config()->factory()->newFormBuilderInstance($this);
