...
namespace srag\RemovePluginDataConfirm\AsqQuestionPool;
...
use ilSession;
use ilUtil;
use srag\DIC\AsqQuestionPool\DICStatic;
use srag\DIC\AsqQuestionPool\DICTrait;

/**
 * Class RemovePluginDataConfirmCtrl
 *
 * @package           srag\RemovePluginDataConfirm\AsqQuestionPool
 *
 * @author            studer + raimann ag - Team Custom 1 <support-custom1@studer-raimann.ch>
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\AsqQuestionPool\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
