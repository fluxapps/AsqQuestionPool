...
/**
 * Class ilObjAsqQuestionPoolAccess
 *
 ...
 */
class ilObjAsqQuestionPoolAccess extends ilObjectPluginAccess
{
    use DICTrait;
    ...
    /**
     * ilObjAsqQuestionPoolAccess constructor
     */
    ...
    {
        $object_settings = self::asqQuestionPool()->objectSettings()->getObjectSettingsById(intval($a_obj_id));
    ...
    {
        ilUtil::sendFailure(self::plugin()->translate("permission_denied", ilObjAsqQuestionPoolGUI::LANG_MODULE_OBJECT), true);
